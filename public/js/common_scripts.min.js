...
!(function (e, t) {
    ...
    E.extend({
      ...
      isPlainObject: function (e) {
        return !(
          ...
          ((e = n(e)) && ('function' != typeof (e = y.call(e, 'constructor') && e.constructor) || s.call(e) !== c))
        );
      },
  ...
  var h = (function (n) {
      ...
      if (!i && (_(t), (t = t || C), T)) {
        if (11 !== p && (l = te.exec(e)))
          if ((o = l[1])) {
            ...
            if ((o = l[3]) && h.getElementsByClassName && t.getElementsByClassName)
          ...
          if (((u = e), (d = t), 1 === p && (U.test(e) || Q.test(e)))) {
            for (
              ((d = (ne.test(e) && me(t.parentNode)) || t) === t && h.scope) ||
                ((a = t.getAttribute('id')) ? (a = a.replace(oe, re)) : t.setAttribute('id', (a = E))),
                r = (c = f(e)).length;
              r--;
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      !(
                        !t ||
                        1 !== t.nodeType ||
                        !(n.contains ? n.contains(t) : e.compareDocumentPosition && 16 & e.compareDocumentPosition(t))
                      )
                    );
                  }
                : function (e, t) {
    ...
    (ae.matchesSelector = function (e, t) {
      if ((_(e), h.matchesSelector && T && !$[t + ' '] && (!a || !a.test(t)) && (!g || !g.test(t))))
        try {
          var n = u.call(e, t);
                    ...
                    if (((l = [v ? u.firstChild : u.lastChild]), v && p)) {
                      for (
                        h =
                          (a =
                            (i =
                              (o = (r = (s = u)[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] ===
                              S && i[1]) && i[2],
                          s = a && u.childNodes[a];
                      ...
                      (p &&
                        (h = a =
                          (i =
                            (o = (r = (s = e)[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] ===
                            S && i[1]),
                      !1 === h)
                    )
                      for (
                        ...
                        ((w ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) ||
                          !++h ||
                          (p && ((o = (r = s[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] = [S, h]),
                          s !== e));
        ...
        if ((t = b.relative[e[a].type])) u = [ve(we(u), t)];
          ...
          if ((t = b.filter[e[a].type].apply(null, e[a].matches))[E]) {
            ...
            return (function e(h, f, m, g, y, t) {
              ...
              1 < a && we(u),
              1 < a && ye(e.slice(0, a - 1).concat({ value: ' ' === e[a - 2].type ? '*' : '' })).replace(F, '$1'),
              t,
              a < n && xe(e.slice(a, n)),
              n < o && xe((e = e.slice(n))),
              n < o && ye(e)
        ...
        function (e, t) {
          ...
          for (s = e, a = [], l = b.preFilter; s; ) {
            ...
            b.filter))
              !(i = G[r].exec(s)) ||
                (l[r] && !(i = l[r](i))) ||
                ((n = i.shift()), o.push({ value: n, type: r, matches: i }), (s = s.slice(n.length)));
            if (!n) break;
          }
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === u.length)) {
            ...
            for (o = G.needsContext.test(e) ? 0 : r.length; o-- && ((s = r[o]), !b.relative[(a = s.type)]); )
              if (
                (l = b.find[a]) &&
                (i = l(s.matches[0].replace(ie, d), (ne.test(r[0].type) && me(t.parentNode)) || t))
              ) {
  ...
  ((E.fn.init = function (e, t, n) {
    ...
    if (i[1]) {
      if (
        ...
        E.merge(this, E.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)),
      ...
      function (i, o) {
        E.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length && (P[i] || E.uniqueSort(n), D.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
    ...
    E.extend({
                      ...
                      (t = e && ('object' == typeof e || 'function' == typeof e) && e.then),
                        w(t)
                          ? a
                            ...
                            : (l++, t.call(e, c(l, r, N, a), c(l, r, M, a), c(l, r, N, r.notifyWith)))
                      ...
                      : function () {
                          try {
                            ...
                            E.Deferred.exceptionHook && E.Deferred.exceptionHook(e, t.stackTrace),
                              l <= o + 1 && (s !== M && ((n = void 0), (i = [e])), r.rejectWith(n, i));
                          }
                        };
      ...
      when: function (e) {
        ...
        var n = arguments.length,
          ...
          r = a.call(arguments),
          s = E.Deferred();
        if (n <= 1 && (z(e, s.done(t(i)).resolve, s.reject, !n), 'pending' === s.state() || w(r[i] && r[i].then)))
          return s.then();
  ...
  (E.fn.ready = function (e) {
    ...
    'complete' === T.readyState || ('loading' !== T.readyState && !T.documentElement.doScroll)
      ...
      : (T.addEventListener('DOMContentLoaded', q), C.addEventListener('load', q));
  var W = function (e, t, n, i, o, r, s) {
      var a = 0,
        l = e.length,
        c = null == n;
      if ('object' === f(n)) for (a in ((o = !0), n)) W(e, t, a, n[a], !0, r, s);
      else if (
        void 0 !== i &&
        ((o = !0),
        w(i) || (s = !0),
    ...
    E.fn.extend({
      data: function (n, e) {
        ...
        if (this.length && ((o = G.get(r)), 1 === r.nodeType && !X.get(r, 'hasDataAttrs'))) {
          for (t = s.length; t--; )
            s[t] && 0 === (i = s[t].name).indexOf('data-') && ((i = Q(i.slice(5))), J(r, i, o[i]));
    ...
    E.fn.extend({
      ...
      promise: function (e, t) {
        ...
        for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
          (i = X.get(s[a], e + 'queueHooks')) && i.empty && (o++, i.empty.add(n));
  ...
  function ae(e, t, n, i) {
    ...
    if (u && u[3] !== c) {
      for (l /= 2, c = c || u[3], u = +l || 1; s--; )
        E.style(e, t, u + c), (1 - r) * (1 - (r = a() / l || 0.5)) <= 0 && (s = 0), (u /= r);
  ...
  (he.tbody = he.tfoot = he.colgroup = he.caption = he.thead),
    (he.th = he.td),
    v.option || (he.optgroup = he.option = [1, "<select multiple='multiple'>", '</select>']);
  var ge = /<|&#?\w+;/;
        ...
        E.event.add(e, o, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[o]) {
              ...
              i.length &&
                (X.set(this, o, { value: E.event.trigger(E.extend(i[0], E.Event.prototype), i.slice(1), this) }),
  ...
  (E.event = {
          ...
          (d = h = (c = ve.exec(e[l]) || [])[1]),
            ...
            d &&
              ...
              (h = a[d]) ||
                ...
                (u.setup && !1 !== u.setup.call(t, i, p, s)) || (t.addEventListener && t.addEventListener(d, s))),
      ...
      if (g && (l = g.events)) {
        for (c = (t = (t || '').match(O) || ['']).length; c--; )
          if (((h = m = (a = ve.exec(t[c]) || [])[1]), (f = (a[2] || '').split('.').sort()), h)) {
            ...
            s &&
              !p.length &&
              ((d.teardown && !1 !== d.teardown.call(e, f, g.handle)) || E.removeEvent(e, h, g.handle), delete l[h]);
    ...
    dispatch: function (e) {
      ...
      if (((a.delegateTarget = this), !e.preDispatch || !1 !== e.preDispatch.call(this, a))) {
        for (r = E.event.handlers.call(this, a, l), t = 0; (i = r[t++]) && !a.isPropagationStopped(); )
          for (a.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !a.isImmediatePropagationStopped(); )
            (a.rnamespace && !1 !== o.namespace && !a.rnamespace.test(o.namespace)) ||
              ((a.handleObj = o),
              (a.data = o.data),
              void 0 !== (o = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) &&
                !1 === (a.result = o) &&
          ...
          if (1 === c.nodeType && ('click' !== e.type || !0 !== c.disabled)) {
            for (r = [], s = {}, n = 0; n < l; n++)
              void 0 === s[(o = (i = t[n]).selector + ' ')] &&
                (s[o] = i.needsContext ? -1 < E(o, this).index(c) : E.find(o, this, null, [c]).length),
                s[o] && r.push(i);
      ...
      e && e.type
        ? ((this.originalEvent = e),
          ...
          (this.isDefaultPrevented =
            e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? we : be),
  ...
  function je(n, i, o, r) {
    ...
    if (
      d &&
      ((t = (e = ye(i, n[0].ownerDocument, !1, n, r)).firstChild), 1 === e.childNodes.length && (e = t), t || r)
    ) {
      for (a = (s = E.map(fe(e, 'script'), ke)).length; u < d; u++)
        (l = e), u !== p && ((l = E.clone(l, !0, !0)), a && E.merge(s, fe(l, 'script'))), o.call(n[u], l, u);
      if (a)
  ...
  function De(e, t, n) {
    for (var i, o = t ? E.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || E.cleanData(fe(i)),
        i.parentNode && (n && oe(i) && me(fe(i, 'script')), i.parentNode.removeChild(i));
    return e;
  }
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (!(v.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e)))
        for (s = fe(u), i = 0, o = (r = fe(e)).length; i < o; i++)
          (a = r[i]),
            'input' === (c = (l = s[i]).nodeName.toLowerCase()) && ue.test(a.type)
              ? (l.checked = a.checked)
              : ('input' !== c && 'textarea' !== c) || (l.defaultValue = a.defaultValue);
      if (t)
        if (n) for (r = r || fe(e), s = s || fe(u), i = 0, o = r.length; i < o; i++) $e(r[i], s[i]);
        else $e(e, u);
      ...
      function (e, s) {
        E.fn[e] = function (e) {
          for (var t, n = [], i = E(e), o = i.length - 1, r = 0; r <= o; r++)
            (t = r === o ? this : this.clone(!0)), E(i[r])[s](t), l.apply(n, t.get());
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == ze &&
              ...
              (ze =
                parseInt(n.height, 10) + parseInt(n.borderTopWidth, 10) + parseInt(n.borderBottomWidth, 10) ===
                t.offsetHeight),
              ie.removeChild(e)),
            ze
          );
      ...
      'margin' === n && (l += E.css(e, n + ne[s], !0, o)),
        i
          ? ('content' === n && (l -= E.css(e, 'padding' + ne[s], !0, o)),
            'margin' !== n && (l -= E.css(e, 'border' + ne[s] + 'Width', !0, o)))
  ...
  function rt(e, t, n) {
    ...
    return (
      ((!v.boxSizingReliable() && o) ||
        ...
        ((o = 'border-box' === E.css(e, 'boxSizing', !1, i)), (r = a in e) && (s = e[a])),
  ...
  E.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          l = et.test(t),
          c = e.style;
        if ((l || (t = Ke(a)), (s = E.cssHooks[t] || E.cssHooks[a]), void 0 === n))
          return s && 'get' in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
        'string' == (r = typeof n) && (o = te.exec(n)) && o[1] && ((n = ae(e, t, o)), (r = 'number')),
          null != n &&
            n == n &&
            ('number' !== r || l || (n += (o && o[3]) || (E.cssNumber[a] ? '' : 'px')),
    ...
    css: function (e, t, n, i) {
      ...
      return (
        et.test(t) || (t = Ke(r)),
        (r = E.cssHooks[t] || E.cssHooks[r]) && 'get' in r && (o = r.get(e, !0, n)),
        void 0 === o && (o = Ve(e, t, i)),
    ...
    E.each(['height', 'width'], function (e, a) {
      E.cssHooks[a] = {
        get: function (e, t, n) {
          if (t)
            return !Je.test(E.css(e, 'display')) || (e.getClientRects().length && e.getBoundingClientRect().width)
              ? rt(e, a, n)
              : Pe(e, tt, function () {
                  return rt(e, a, n);
                });
        ...
        set: function (e, t, n) {
          ...
          return (
            s &&
              r &&
              (n -= Math.ceil(
                e['offset' + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - ot(e, a, 'border', !1, o) - 0.5
              )),
            n && (i = te.exec(t)) && 'px' !== (i[3] || 'px') && ((e.style[a] = t), (t = E.css(e, a))),
            it(0, t, n)
          );
        },
      };
  ...
  function dt() {
    lt &&
      (!1 === T.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(dt) : C.setTimeout(dt, E.fx.interval),
      E.fx.tick());
  }
  function pt() {
    return (
  ...
  function mt(o, e, t) {
    var n,
      ...
      l = function () {
        ...
        for (
          ...
          c.tweens[n].run(t);
        return (
          a.notifyWith(o, [c, t, e]), t < 1 && i ? e : (i || a.notifyWith(o, [c, 1, 0]), a.resolveWith(o, [c]), !1)
        );
      },
      c = a.promise({
        elem: o,
    ...
    for (
      ...
      if ((n = mt.prefilters[i].call(c, o, u, c.opts)))
        return w(n.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
    return (
      E.map(u, ft, c),
  ...
  (E.Animation = E.extend(mt, {
    ...
    tweener: function (e, t) {
      for (var n, i = 0, o = (e = w(e) ? ((t = e), ['*']) : e.match(O)).length; i < o; i++)
        ...
        if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
          for (i in (u &&
            ...
            'none' === (u = E.css(e, 'display')) &&
              (c ? (u = c) : (ce([e], !0), (c = e.style.display || c), (u = E.css(e, 'display')), ce([e]))),
          ...
          p))
            l ||
              (m ? 'hidden' in m && (f = m.hidden) : (m = X.access(e, 'fxshow', { display: c })),
              r && (m.hidden = !f),
              f && ce([e], !0),
              d.done(function () {
    ...
    (E.speed = function (e, t, n) {
      var i =
        e && 'object' == typeof e
          ? E.extend({}, e)
          : { complete: n || (!n && t) || (w(e) && e), duration: e, easing: (n && t) || (t && !w(t) && t) };
      return (
        E.fx.off
          ? (i.duration = 0)
          : 'number' != typeof i.duration &&
            (i.duration in E.fx.speeds ? (i.duration = E.fx.speeds[i.duration]) : (i.duration = E.fx.speeds._default)),
        ...
        return (
          ...
          this.each(function () {
            var e,
              ...
              o = E.timers,
              r = n ? n.length : 0;
            for (t.finish = !0, E.queue(this, s, []), i && i.stop && i.stop.call(this, !0), e = o.length; e--; )
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== r && 8 !== r && 2 !== r)
          return void 0 === e.getAttribute
            ? E.prop(e, t, n)
            : ((1 === r && E.isXMLDoc(e)) ||
                (o = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? gt : void 0)),
              void 0 !== n
                ? null === n
                ...
                : !(o && 'get' in o && null !== (i = o.get(e, t))) && null == (i = E.find.attr(e, t))
                ? void 0
                : i);
      },
      attrHooks: {
          ...
          : this.each(function () {
              ...
              if (s)
                ...
                (void 0 !== o && 'boolean' != r) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute('class', (!e && !1 !== o && X.get(this, '__className__')) || ''));
            });
      },
      hasClass: function (e) {
    ...
    E.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (var n, i, o = e.options, r = E.makeArray(t), s = o.length; s--; )
      ...
      if (
        ...
        for (o = 0; (f = d[o++]) && !e.isPropagationStopped(); )
          (u = f),
            ...
            (l = (X.get(f, 'events') || Object.create(null))[e.type] && X.get(f, 'handle')) && l.apply(f, t),
            (l = a && f[a]) && l.apply && U(f) && ((e.result = l.apply(f, t)), !1 === e.result && e.preventDefault());
        return (
          (e.type = p),
          i ||
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          try {
            (i.href = f.url),
              (i.href = i.href),
              (f.crossDomain = Wt.protocol + '//' + Wt.host != i.protocol + '//' + i.host);
          } catch (e) {
            f.crossDomain = !0;
          }
        }
        if (
          (f.data && f.processData && 'string' != typeof f.data && (f.data = E.param(f.data, f.traditional)),
          Ft(Ht, f, t, x),
          p)
        )
          return x;
        for (o in ((h = E.event && f.global) && 0 == E.active++ && E.event.trigger('ajaxStart'),
        ...
        f.hasContent
          ...
          : ((r = f.url.slice(c.length)),
            ...
            !1 === f.cache && ((c = c.replace(Ot, '$1')), (r = (kt.test(c) ? '&' : '?') + '_=' + At.guid++ + r)),
            (f.url = c + r)),
        f.ifModified &&
          (E.lastModified[c] && x.setRequestHeader('If-Modified-Since', E.lastModified[c]),
        ...
        x.setRequestHeader(
          ...
          f.dataTypes[0] && f.accepts[f.dataTypes[0]]
            ? f.accepts[f.dataTypes[0]] + ('*' !== f.dataTypes[0] ? ', ' + qt + '; q=0.01' : '')
            : f.accepts['*']
        ),
        f.headers))
        ...
        function _(e, t, n, i) {
          ...
          p ||
            ...
            i
              ? (f.ifModified &&
                  ((n = x.getResponseHeader('Last-Modified')) && (E.lastModified[c] = n),
            ...
            v.fireWith(m, [x, a]),
            h && (g.trigger('ajaxComplete', [x, f]), --E.active || E.event.trigger('ajaxStop')));
        }
        return x;
      },
    ...
    E.each(['get', 'post'], function (e, o) {
      E[o] = function (e, t, n, i) {
        return (
          ...
          E.ajax(E.extend({ url: e, type: o, dataType: i, data: t, success: n }, E.isPlainObject(e) && e))
        );
      };
    }),
  ...
  E.ajaxSetup({
      ...
      if (s || 'jsonp' === e.dataTypes[0])
        return (
          ...
          s
            ...
            : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? '&' : '?') + e.jsonp + '=' + i),
    ...
    (v.createHTMLDocument =
      (((d = T.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
    ...
    (E.parseHTML = function (e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          t ||
            (v.createHTMLDocument
              ? (((i = (t = T.implementation.createHTMLDocument('')).createElement('base')).href = T.location.href),
                t.head.appendChild(i))
              : (t = T)),
          (i = !n && []),
          (n = k.exec(e))
            ? [t.createElement(n[1])]
            : ((n = ye([e], t, i)), i && i.length && E(i).remove(), E.merge([], n.childNodes)));
      var i;
    }),
            ...
            return (
              ...
              void 0 === n
                ? i
                  ? i[o]
                  : e[t]
                : void (i ? i.scrollTo(r ? i.pageXOffset : n, r ? n : i.pageYOffset) : (e[t] = n))
            );
          },
          t,
          e,
    ...
    E.each({ Height: 'height', Width: 'width' }, function (s, a) {
      E.each({ padding: 'inner' + s, content: a, '': 'outer' + s }, function (i, r) {
        E.fn[r] = function (e, t) {
          ...
          function (e) {
            e.forEach(function (e) {
              return (i = e).isIntersecting || 0 < i.intersectionRatio
                ? ((t = e.target), (i = (n = o)._settings), p(i.callback_enter, t), void (i.load_delay ? P : j)(t, n))
                : (function (e, t) {
                    t = t._settings;
          ...
          function h() {
            m = a
              ? (!s &&
                ...
                (s ? s.clientHeight : 0) || f.window.innerHeight || document.documentElement.clientHeight)
          ...
          var v = 0,
            w = (function () {
              function a(e, t) {
                ...
                t && 'object' === c(t) && void 0 !== t.length && (t = l(t, 1)[0]),
              ...
              return (
                ...
                (t = [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      g.push({ instance: this }), 1 === g.length && f.window.requestAnimationFrame(y);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        o &&
                          (i < 0 ? ((r = i * Math.max(n, m)), m < n && (r -= i * (n - m))) : (r = i * (n + m)),
                          1 < i ? (s = Math.abs(r - m)) : i < 0 ? (s = r / i + Math.abs(r)) : (s += (m - n) * (1 - i)),
                          (r /= 2)),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t,
                        ...
                        p = {},
                        h = c;
                      l.options.elementInViewport && (h = l.options.elementInViewport.getBoundingClientRect()),
                        (l.isElementInViewport =
                          0 <= h.bottom && 0 <= h.right && h.top <= m && h.left <= f.window.innerWidth),
            ...
            i = function (e, t) {
              ('object' === ('undefined' == typeof HTMLElement ? 'undefined' : c(HTMLElement))
                ...
                (e = [e]);
              for (
                var n, i = e.length, o = 0, r = arguments.length, s = new Array(2 < r ? r - 2 : 0), a = 2;
                a < r;
                a++
              )
                s[a - 2] = arguments[a];
              for (; o < i; o += 1)
                if (
                  ('object' === c(t) || void 0 === t
                    ...
                    : e[o].jarallax && (n = e[o].jarallax[t].apply(e[o].jarallax, s)),
                  void 0 !== n)
                )
                  return n;
              return e;
              ...
              function i(e, t) {
                ...
                (n.url = e),
                  ...
                  void 0 !== n.options.showContols &&
                    ((n.options.showControls = n.options.showContols), delete n.options.showContols),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t,
                        ...
                        s =
                          !(
                            !(t = (t = e).match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) ||
                            11 !== t[1].length
                          ) && t[1],
                        a =
                          !(
                    ...
                    value: function (e) {
                      ...
                      t.player &&
                        ('youtube' === t.type &&
                          ...
                          u().YT.PlayerState.PLAYING !== t.player.getPlayerState() && t.player.playVideo()),
                        'vimeo' === t.type &&
                        ...
                        'local' === t.type &&
                          (void 0 !== e && (t.player.currentTime = e), t.player.paused && t.player.play()));
                    },
                  },
                  {
                    key: 'pause',
                    value: function () {
                      ...
                      t.player &&
                        ('youtube' === t.type &&
                          t.player.pauseVideo &&
                          u().YT.PlayerState.PLAYING === t.player.getPlayerState() &&
                          t.player.pauseVideo(),
                        'vimeo' === t.type &&
                          t.player.getPaused().then(function (e) {
                            e || t.player.pause();
                      ...
                      o.videoImage
                        ...
                        : ('youtube' === o.type &&
                            ...
                            ((i = new Image()).onload = function () {
                              120 !== (this.naturalWidth || this.width) || n === e.length - 1
                          ...
                          'vimeo' === o.type &&
                            ((i = new XMLHttpRequest()).open(
                              'GET',
                              'https://vimeo.com/api/v2/video/'.concat(o.videoID, '.json'),
                              !0
                            ),
                            (i.onreadystatechange = function () {
                              var e;
                            ...
                            c.$video || ((e = document.createElement('div')).style.display = 'none'),
                              'youtube' === c.type &&
                                ...
                                (c.playerOptions.events = {
                                  onReady: function (t) {
                                    c.options.mute
                                      ? t.target.mute()
                                      : c.options.volume && t.target.setVolume(c.options.volume),
                                      c.options.autoplay && c.play(c.options.startTime),
                                      c.fire('ready', t),
                                      c.options.loop &&
                                        !c.options.endTime &&
                                        (c.options.endTime = c.player.getDuration() - 0.1),
                                  ...
                                  onStateChange: function (e) {
                                    c.options.loop &&
                                      ...
                                      t || e.data !== u().YT.PlayerState.PLAYING || ((t = 1), c.fire('started', e)),
                                      e.data === u().YT.PlayerState.PLAYING && c.fire('play', e),
                                      e.data === u().YT.PlayerState.PAUSED && c.fire('pause', e),
                                      e.data === u().YT.PlayerState.ENDED && c.fire('ended', e),
                                      e.data === u().YT.PlayerState.PLAYING
                                        ? (n = setInterval(function () {
                                            c.fire('timeupdate', e),
                                              c.options.endTime &&
                                                c.player.getCurrentTime() >= c.options.endTime &&
                                                (c.options.loop ? c.play(c.options.startTime) : c.pause());
                                          }, 150))
                                        : clearInterval(n);
                                  },
                                  onError: function (e) {
                                ...
                                (i = !c.$video) &&
                                  ((o = document.createElement('div')).setAttribute('id', c.playerID),
                                  e.appendChild(o),
                                  document.body.appendChild(e)),
                                (c.player = c.player || new (u().YT.Player)(c.playerID, c.playerOptions)),
                                i &&
                              ...
                              'vimeo' === c.type &&
                                ...
                                c.$video ||
                                  ...
                                  c.$video.setAttribute(
                                    'src',
                                    'https://player.vimeo.com/video/'.concat(c.videoID, '?').concat(r)
                                  ),
                                  ...
                                  document.body.appendChild(e)),
                                (c.player = c.player || new (u().Vimeo.Player)(c.$video, c.playerOptions)),
                                c.options.startTime &&
                                  c.options.autoplay &&
                              ...
                              'local' === c.type &&
                                (c.$video ||
                                  ...
                                  c.options.mute
                                    ? (c.$video.muted = !0)
                                    : c.$video.volume && (c.$video.volume = c.options.volume / 100),
                                  ...
                                  Object.keys(c.videoID).forEach(function (e) {
                                    ...
                                    (t = c.$video),
                                      (n = c.videoID[e]),
                                      (i = 'video/'.concat(e)),
                                      ((e = document.createElement('source')).src = n),
                                      (e.type = i),
                                      t.appendChild(e);
                                  })),
                    ...
                    value: function () {
                      if (!a || !l) {
                        var e,
                          ...
                          n = '';
                        if (
                          ('youtube' !== this.type || a || ((a = 1), (n = 'https://www.youtube.com/iframe_api')),
                          'vimeo' === this.type && !l)
                        ) {
        ...
        function (e, t, n) {
          ...
          function i() {
            var e,
              ...
              o,
              t,
              i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : s().jarallax;
            void 0 !== i &&
              ((i = i.constructor),
                        ...
                        'local' === n.video.type &&
                          (n.image.src
                            ...
                            : n.image.$item &&
                              ...
                              n.image.$item.src &&
                              n.$video.setAttribute('poster', n.image.$item.src)),
              ...
              (i.prototype.coverImage = function () {
                ...
                return (
                  r &&
                    ...
                    s &&
                    ('IFRAME' === s || 'VIDEO' === s) &&
                    ((t = ((e = r.image.height) * o.image.width) / o.image.height),
                    (n = (r.container.width - t) / 2),
                    (i = r.image.marginTop),
                    r.container.width > t &&
                      ((e = ((t = r.container.width) * o.image.height) / o.image.width),
                      (n = 0),
                ...
                if (t.isValid())
                  if (
                    (this.options.disableParallax() &&
                      ((e = !0), (n.image.position = 'absolute'), (n.options.type = 'scroll'), (n.options.speed = 1)),
                    e)
                  ) {
                    if (
                      (t.on('ready', function () {
                        ...
                        n.options.videoPlayOnlyVisible
                          ? ((e = n.onScroll),
                            (n.onScroll = function () {
                              e.apply(n),
                                n.videoError ||
                                  (!n.options.videoLoop && (n.options.videoLoop || n.videoEnded)) ||
    ...
    (c.Defaults = {
      ...
      (c.Workers = [
        ...
        },
        {
          ...
          run: function (e) {
            var t = this.settings.margin || '',
              ...
              i = this.settings.rtl,
              t = { width: 'auto', 'margin-left': i ? t : '', 'margin-right': i ? '' : t };
        ...
        },
        {
          ...
          run: function () {
            for (
              var e, t, n = this.settings.rtl ? 1 : -1, i = this._clones.length + this._items.length, o = -1, r = [];
              ++o < i;

            )
              (e = r[o - 1] || 0), (t = this._widths[this.relative(o)] + this.settings.margin), r.push(e + t * n);
            this._coordinates = r;
          },
        },
        {
          ...
          run: function () {
            for (
              ...
              (e = this._coordinates[a - 1] || 0),
                ...
                ((this.op(e, '<=', o) && this.op(e, '>', r)) || (this.op(t, '<', o) && this.op(t, '>', r))) &&
                  s.push(a);
      ...
      (c.prototype.initializeStage = function () {
        (this.$stage = this.$element.find('.' + this.settings.stageClass)),
          this.$stage.length ||
            ...
            (this.$stage = l('<' + this.settings.stageElement + '>', { class: this.settings.stageClass }).wrap(
      ...
      (c.prototype.setup = function () {
        ...
        e
          ? (l.each(e, function (e) {
            ...
            'function' == typeof (i = l.extend({}, this.options, e[n])).stagePadding &&
      ...
      (c.prototype.update = function () {
        for (
          ...
          (this._invalidated.all || 0 < l.grep(this._pipe[e].filter, n).length) && this._pipe[e].run(i), e++;
      ...
      (c.prototype.onDragStart = function (e) {
        ...
        3 !== e.which &&
          ...
          this.is('animating') &&
            (l.support.transform ? this.animate(t.x) : this.$stage.stop(), this.invalidate('position')),
        ...
        this.is('dragging') &&
          ...
          this.settings.loop
            ? ((n = this.coordinates(this.minimum())),
              ...
              (r.x = ((((r.x - n) % i) + i) % i) + n))
            : ((n = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum())),
      ...
      (c.prototype.onDragEnd = function (e) {
        ...
        l(i).off('.owl.core'),
          ...
          ((0 !== t.x && this.is('dragging')) || !this.is('valid')) &&
            ...
            this.current(this.closest(n.x, 0 !== t.x ? e : this._drag.direction)),
      ...
      (c.prototype.current = function (e) {
        return e === a
          ...
          : ((e = this.normalize(e)),
            this._current !== e &&
              ((t = this.trigger('change', { property: { name: 'position', value: e } })).data !== a &&
      ...
      (c.prototype.normalize = function (e, t) {
        ...
        return (
          !this.isNumeric(e) || n < 1 ? (e = a) : (e < 0 || n + t <= e) && (e = ((((e - t / 2) % n) + n) % n) + t / 2),
          e
        );
      }),
        ...
        if (o.loop) r = this._clones.length / 2 + this._items.length - 1;
          ...
          if ((t = this._items.length))
            for (
              ...
              t-- && !(i < (n += this._items[t].width() + this.settings.margin));
        ...
        return e === a
          ...
          : (this.settings.center
              ? (this.settings.rtl && ((n = -1), (i = e + 1)),
                ...
                (t += ((this.width() - t + (this._coordinates[i] || 0)) / 2) * n))
      ...
      (c.prototype.onTransitionEnd = function (e) {
        if (e !== a && (e.stopPropagation(), (e.target || e.srcElement || e.originalTarget) !== this.$stage.get(0)))
          return !1;
      ...
      (c.prototype.destroy = function () {
        ...
        !1 !== this.settings.responsive &&
          (n.clearTimeout(this.resizeTimer), this.off(n, 'resize', this._handlers.onThrottledResize)),
        this._plugins))
      ...
      (c.prototype.trigger = function (e, t, n, i, o) {
        var r = { item: { count: this._items.length, index: this.current() } },
          ...
          a = l.Event([e, 'owl', n || 'carousel'].join('.').toLowerCase(), l.extend({ relatedTarget: this }, r, t));
        return (
          this._supress[e] ||
        ...
        n.type === c.Type.Event
          ...
          : n.type === c.Type.State &&
            (this._states.tags[n.name]
              ? (this._states.tags[n.name] = this._states.tags[n.name].concat(n.tags))
                ...
                n.$element.on(
                  ...
                  l.proxy(function (e) {
                    e.namespace &&
                      ...
                      (this.suppress([t]), n[t].apply(this, [].slice.call(arguments, 1)), this.release([t]));
                  }, n)
                );
            })),
        ...
        (this._handlers = {
          'initialized.owl.carousel change.owl.carousel resized.owl.carousel': a.proxy(function (e) {
            if (
              ...
              for (0 < t.lazyLoadEager && ((n += t.lazyLoadEager), t.loop && ((o -= t.lazyLoadEager), n++)); i++ < n; )
      ...
      (this._core = e),
        ...
        (this._handlers = {
          ...
          'prepared.owl.carousel': u.proxy(function (e) {
            var t;
            !e.namespace ||
              ((t = u(e.content).find('.owl-video')).length && (t.css('display', 'none'), this.fetch(t, u(e.content))));
          }, this),
        }),
    ...
    (n.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (n.prototype.thumbnail = function (t, e) {
        function n(e) {
          (i = c.lazyLoad
            ...
            : u('<div/>', { class: 'owl-video-tn', style: 'opacity:1;background-image:url(' + e + ')' })),
            t.after(i),
            t.after('<div class="owl-video-play-icon"></div>');
        }
        var i,
          o,
          r = e.width && e.height ? 'width:' + e.width + 'px;height:' + e.height + 'px;' : '',
          s = t.find('img'),
          a = 'src',
          l = '',
      ...
      (n.prototype.play = function (e) {
        ...
        this._playing ||
          ...
          (e = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr(
            'height',
            o
          ),
          e.attr('width', i),
          ...
          this.core.current() !== this.previous &&
            (r &&
              ...
              n
                ...
                .addClass(r)),
            o && i.one(s.support.animation.end, t).addClass('animated owl-animated-in').addClass(o)));
      }),
    ...
    (t.Defaults = {
      ...
      (t.prototype.initialize = function () {
        ...
        for (e in ((this._controls.$relative = (
          n.navContainer ? o(n.navContainer) : o('<div>').addClass(n.navContainerClass).appendTo(this.$element)
        ).addClass('disabled')),
        ...
        n.dotsData ||
          (this._templates = [o('<button role="button">').addClass(n.dotClass).append(o('<span>')).prop('outerHTML')]),
        (this._controls.$absolute = (
          n.dotsContainer ? o(n.dotsContainer) : o('<div>').addClass(n.dotsClass).appendTo(this.$element)
        ).addClass('disabled')),
      ...
      (t.prototype.destroy = function () {
        ...
        for (t in this._controls)
          '$relative' === t && o.navContainer ? this._controls[t].html('') : this._controls[t].remove();
      ...
      (t.prototype.update = function () {
        ...
        if (('page' !== r.slideBy && (r.slideBy = Math.min(r.slideBy, r.items)), r.dots || 'page' == r.slideBy))
          for (this._pages = [], e = n, t = 0; e < i; e++) {
            if (s <= t || 0 === t) {
              if ((this._pages.push({ start: Math.min(o, e - n), end: e - n + s - 1 }), Math.min(o, e - n) === o))
                break;
              (t = 0), 0;
            }
      ...
      (t.prototype.draw = function () {
        ...
        this._controls.$relative.toggleClass('disabled', !e.nav || t),
          e.nav &&
            (this._controls.$previous.toggleClass('disabled', !i && n <= this._core.minimum(!0)),
      ...
      (t.prototype.to = function (e, t, n) {
        !n && this._pages.length
          ? ((n = this._pages.length), o.proxy(this._overrides.to, this._core)(this._pages[((e % n) + n) % n].start, t))
      ...
      (this._core = e),
        ...
        (this._handlers = {
          ...
          'prepared.owl.carousel': i.proxy(function (e) {
            var t;
            !e.namespace ||
              ((t = i(e.content).find('[data-hash]').addBack('[data-hash]').attr('data-hash')) &&
  ...
  (function (o, r) {
    ...
    !(function () {
      ...
      t() && ((o.support.transform = new String(c('transform'))), (o.support.transform3d = n()));
...
const scrollCue = (function () {
  let r = {},
    ...
    n = !1,
    u,
    i = { duration: 600, interval: -0.7, percentage: 0.75, enable: !0, docSlider: !1, pageChangeReset: !1 };
  return (
    (r = {
        ...
        if ((l && !e && window.addEventListener('load', r.runQuery), window.addEventListener('scroll', n), c)) {
          ...
          for (let t = 0; t < i.length; t++) {
            ...
            e.addEventListener('scroll', function (e) {
              return (
                docSlider.getCurrentIndex() + '' === e.target.getAttribute('data-ds-index') &&
          ...
          return (
            Object.keys(t).forEach(function (e) {
              '[object Object]' === Object.prototype.toString.call(t[e])
                ...
                : ((i[e] = t[e]), void 0 !== n && void 0 !== n[e] && (i[e] = n[e]));
            }),
            i
          );
      },
      ...
      runQuery: function () {
        ...
        for (let e = 0; e < o.length; e++) {
          ...
          if (r.isElementIn(n[0].elm)) {
            'reverse' === n[0].sort ? n.reverse() : 'random' === n[0].sort && r.randElements(n),
...
!(function (o) {
  o.fn.niceSelect = function (e) {
    ...
    return (
      (e.cssText = 'pointer-events:auto'), 'auto' !== e.pointerEvents && o('html').addClass('no-csspointerevents'), this
    );
  };
})(jQuery),
  (function (e) {
    ...
    function h(e) {
      return (
        (e === t && f.currTemplate.closeBtn) ||
          ((f.currTemplate.closeBtn = c(f.st.closeMarkup.replace('%title%', f.st.tClose))), (t = e)),
    ...
    (e.prototype = {
      ...
      open: function (e) {
        ...
        if (!f.isOpen) {
          (f.types = []),
            ...
            e.key
              ? (f.popupsCache[e.key] || (f.popupsCache[e.key] = {}), (f.currTemplate = f.popupsCache[e.key]))
              : (f.currTemplate = {}),
          ...
          p('BeforeOpen'),
            ...
            f.fixedContentPos
              ? f.wrap.css({ overflow: f.st.overflowY, overflowX: 'hidden', overflowY: f.st.overflowY })
              : f.wrap.css({ top: _.scrollTop(), position: 'absolute' }),
            (!1 !== f.st.fixedBgPos && ('auto' !== f.st.fixedBgPos || f.fixedContentPos)) ||
          ...
          return (
            ...
            setTimeout(function () {
              f.content ? (f._addClassToMFP(x), f._setFocus()) : f.bgOverlay.addClass(x),
      ...
      updateItemHTML: function () {
        ...
        p('BeforeChange', [f.currItem ? f.currItem.type : '', t]),
          (f.currItem = e),
          f.currTemplate[t] ||
            ((n = !!f.st[t] && f.st[t].markup), p('FirstMarkupParse', n), (f.currTemplate[t] = !n || c(n))),
      ...
      addGroup: function (t, n) {
        ...
        ((n = n || {}).mainEl = t),
          n.items
            ...
            : ((n.isObj = !1), n.delegate ? t.off(i).on(i, n.delegate, e) : (n.items = t).off(i).on(i, e));
      },
          ...
          'string' == typeof e
            ? 'open' === e
              ? ((t = a ? o.data('magnificPopup') : o[0].magnificPopup),
                ...
                (i = t.items ? t.items[n] : ((i = o), t.delegate && (i = i.find(t.delegate)), i.eq(n))),
                f._openClick({ mfpEl: i }, o, t))
              : f.isOpen && f[e].apply(f, Array.prototype.slice.call(arguments, 1))
            : ((e = c.extend(!0, {}, e)), a ? o.data('magnificPopup', e) : (o[0].magnificPopup = e), f.addGroup(o, e)),
          o
        );
      });
    function C() {
      ...
      proto: {
        ...
        _onImageHasSize: function (e) {
          e.img &&
            ...
            p('ImageHasSize', e),
            e.imgHidden && (f.content && f.content.removeClass('mfp-loading'), (e.imgHidden = !1)));
        },
            ...
            o = function (e) {
              D && clearInterval(D),
                (D = setInterval(function () {
                  0 < i.naturalWidth
                    ? f._onImageHasSize(t)
                    : (200 < n && clearInterval(D), 3 === ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500));
                }, e));
            };
          o(1);
        },
        getImage: function (e, t) {
          var n,
            ...
            o = function () {
              e &&
                (e.img[0].complete
                  ? (e.img.off('.mfploader'),
                    e === f.currItem && (f._onImageHasSize(e), f.updateStatus('ready')),
                    (e.hasSize = !0),
                    (e.loaded = !0),
                    p('ImageLoadComplete'))
                  : ++i < 200
            ...
            r = function () {
              e &&
                (e.img.off('.mfploader'),
                e === f.currItem && (f._onImageHasSize(e), f.updateStatus('error', s.tError.replace('%url%', e.src))),
                (e.hasSize = !0),
                (e.loaded = !0),
                (e.loadError = !0));
            },
          ...
          return (
            ...
            e.hasSize
              ? (D && clearInterval(D),
                e.loadError
                  ? (t.addClass('mfp-loading'), f.updateStatus('error', s.tError.replace('%url%', e.src)))
    ...
    c.magnificPopup.registerModule('zoom', {
      ...
      proto: {
        ...
        _getOffset: function (e) {
          ...
          i = { width: t.width(), height: (a ? t.innerHeight() : t[0].offsetHeight) - e - i };
          return (
            void 0 === P && (P = void 0 !== document.createElement('p').style.MozTransform),
            P
              ? (i['-moz-transform'] = i.transform = 'translate(' + n.left + 'px,' + n.top + 'px)')
    ...
    function L(e) {
      ...
      !f.currTemplate[O] ||
        ((t = f.currTemplate[O].find('iframe')).length &&
          (e || (t[0].src = '//about:blank'), f.isIE8 && t.css('display', e ? 'block' : 'none')));
    }
    var O = 'iframe';
    ...
    c.magnificPopup.registerModule('gallery', {
      ...
      proto: {
          ...
          (g += ' mfp-gallery'),
            ...
            u('BuildControls' + e, function () {
              ...
              1 < f.items.length &&
                ...
                !f.arrowLeft &&
                ((t = r.arrowMarkup),
                (e = f.arrowLeft = c(t.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, 'left')).addClass(s)),
                (t = f.arrowRight = c(t.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, 'right')).addClass(s)),
                e.click(function () {
                  f.prev();
                }),
                t.click(function () {
        ...
        preloadNearbyImages: function () {
          for (
            var e = f.st.gallery.preload, t = Math.min(e[0], f.items.length), n = Math.min(e[1], f.items.length), i = 1;
            i <= (f.direction ? n : t);
            i++
          )
  ...
  (function (e) {
    ...
    (s.prototype = {
        ...
        if (
          ...
          e.enable &&
            ...
            'infer' === e.toggle.position &&
              (e.toggle.position = 'rtl' === this.element.css('text-direction') ? 'left' : 'right'),
      ...
      isType: function (e, t) {
        return (
          (t = t || this.options.states)[(e = e || this.state(i, i, t).props.type)] && (e = t[e].props.type),
      ...
      wrapElement: function (n) {
        ...
        return (
          this.wrapperElement.length ||
            ...
            this.element.css(n.innerElementStyles).wrap(r(n.element).addClass(n.className).css(n.styles)),
          ...
          this.toggleElement.length ||
            ...
            e.touchSupport
              ? (this.toggleElement.css(e.touchStyles),
                this.element.on(e.attachToTouchEvent, r.proxy(this.toggleTouchEvent, this)))
              : this.toggleElement.on(e.attachToEvent, r.proxy(this.toggleEvent, this)),
            e.attachToKeyCodes.length && this.toggleElement.on(e.attachToKeyEvent, r.proxy(this.toggleKeyEvent, this))),
          this.toggleElement
        );
      },
      ...
      updateToggle: function (e, t) {
        ...
        return (
          this.toggleElement.length &&
            ...
            (e = this.toggleElement.outerWidth() + 2 * this.options.toggle.offset),
      ...
      toggleTouchEvent: function (e) {
        ...
        i &&
          ...
          (n =
            'left' === this.options.toggle.position ? ((t = n), (i += this.toggleElement.outerWidth())) : ((t = i), n)),
                ...
                ('!' === s &&
                  (l = (function (e, t) {
                    var n = 's',
                      i = '';
                    e &&
                      ((e = e.replace(/(:|;|\s)/gi, '').split(/\,/)), (n = 1 === e.length ? e[0] : ((i = e[0]), e[1])));
          ...
          void 0 !== t
            ? ((e = o[t]),
              ...
              s.prototype.hasOwnProperty(t)
                ...
                : i.error('Method %s does not exist on jQuery.countdown'.replace(/\%s/gi, t)))
            : new s(this, n[0], n[1]);
        });
      });
  }),
  (function (e) {
    ...
    var f = (d.cookie = function (e, t, n) {
      ...
      if (1 < arguments.length && !d.isFunction(t))
        return (
          'number' == typeof (n = d.extend({}, f.defaults, n)).expires &&
            ((o = n.expires), (i = n.expires = new Date()).setMilliseconds(i.getMilliseconds() + 864e5 * o)),
          (document.cookie = [
            p(e),
            '=',
      ...
      for (
        var r = e ? void 0 : {}, s = document.cookie ? document.cookie.split('; ') : [], a = 0, l = s.length;
        a < l;
        a++
      ) {
        var c = s[a].split('='),
  ...
  $('.popup_close').on('click', function () {
    $('.popup_wrapper').fadeOut(300), $.cookie('cookie_popup', 'monster', { expires: 7, path: '/' });
  }),
